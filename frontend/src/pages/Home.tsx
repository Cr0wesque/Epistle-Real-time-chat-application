        ...
        <div className="h-full overflow-hidden flex flex-col">
            <div className="flex-1 flex flex-col space-y-8 items-center justify-center">
                ...
                <div className="text-center">
                    <h1 className="font-bold text-6xl lg:text-8xl">Epistle</h1>
            ...
            <div className="p-2">
                <p className="text-center text-sm lg:text-base text-muted-foreground text">
                    © 2026 Epistle. All rights reserved. <a href="https://pankil-soni.github.io/" target="_blank" className="underline text-primary">Pankil Soni</a>
                </p>
            </div>
        </div>
    )
